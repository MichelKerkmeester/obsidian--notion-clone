...
// COMPONENT: Chart.js chart view — aggregates rows, drives the chart instance lifecycle, and renders PNG export and row drilldown
// ───────────────────────────────────────────────────────────────────
//
// render() computes a structural signature (chart type, fields, legend,
// labels, axis settings) against the previous render before deciding
// whether to destroy and recreate the Chart.js instance or patch
// chart.data in place — a full rebuild on every refresh would flicker
// and drop the existing zoom/legend state.
...
import { Chart } from "../../../src/data/chart-js-setup";
import {
  aggregateChart,
  aggregateMixedChart,
...
} from "../../../src/data/chart-aggregation";
import { getChartPaletteColors, getChartStatusColors } from "../../../src/data/chart-palettes";
import { formatChartDrilldownCellValue, getChartFilterRules, getChartTitle, getChartHeightClass, getDrilldownRows, isChartCumulativeSupported, normalizeChartAggregationForValueField } from "../../../src/data/chart-view-model";
import { ChartColorPalette, ChartReferenceLine, ChartType, ColumnDef, FilterRule, RowData, StatusColor, ViewConfig } from "../../../src/data/types";
import { STATUS_COLORS } from "../../../src/data/status-colors";
import { t } from "../../../src/i18n";
import { isHTMLElement } from "../../../src/views/dom-guards";
import { DbModal } from "../../../src/views/modals/obnotion-modal";
import { EmptyStateAction, EmptyStateReason, EmptyStateRenderer } from "../../../src/views/empty-state-renderer";
import type { SurfaceShellRole } from "../../../src/views/surface-shell";
