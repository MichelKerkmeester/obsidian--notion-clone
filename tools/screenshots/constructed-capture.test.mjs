...
describe("constructed scenario registry", () => {
  it("registers one scenario per view with a constructed-<view> id", () => {
    ...
    expect(ids).toEqual([
      ...
      "constructed-modal-sheet-confirm",
      "constructed-modal-sheet-confirm-stacked",
      "constructed-modal-sheet-property-editor",
      "constructed-modal-sheet-property-editor-stacked",
...
describe("fixture declarations", () => {
  it("marks every hand-written fixture the constructed captures supersede", async () => {
    ...
    expect(declared).toEqual([
      ...
      "panel-board-groups -> constructed-board-groups-panel",
