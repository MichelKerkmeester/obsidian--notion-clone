    ...
    html: () => {
      const row = (name, start, end, span) => `
        <div class="db-invalid-event-row">
          ...
          <div class="db-invalid-event-time">${start}</div>
          <div class="db-invalid-event-time">${end}</div>
          <div class="db-invalid-event-span">${span}</div>
        </div>`;
      return `
      <div class="note-database-modal db-invalid-events-modal">
        ...
        <div class="db-invalid-event-grid">
          ...
          ${row("Design review", "2026-03-04 14:00", "2026-03-04 13:00", "-1h")}
          ${row("Quarterly planning", "2026-03-11 09:30", "2026-03-11 09:00", "-30m")}
          ${row("Retrospective", "2026-03-18 16:00", "2026-03-18 15:15", "-45m")}
        </div>
      </div>`;
    },
  },
