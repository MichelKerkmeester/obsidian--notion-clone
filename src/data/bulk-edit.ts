// ───────────────────────────────────────────────────────────────────
// MODULE:    bulk-edit
// COMPONENT: multi-record bulk edit planning, impact prediction, and value normalization
// ───────────────────────────────────────────────────────────────────
//
// buildBulkEditPlan computes the would-be change set (and skips true no-ops)
// without writing anything, so buildBulkEditImpact can warn the user before
// a commit — e.g. a bulk edit that would move a record out of the grouping
// field's current value, or drop it out of the active view/database
// entirely. Keeping normalization (normalizeBulkValue/normalizeComparable)
// shared between planning and no-op detection is what makes "no-op" mean
// the same thing in both places instead of drifting apart over time.
...
import { OptionRegistrationPlan, planOptionRegistration } from "./option-registration";
...
// ───────────────────────────────────────────────────────────────────
// 4. EDITABLE COLUMNS & EDITOR STATE
// ───────────────────────────────────────────────────────────────────
