// ───────────────────────────────────────────────────────────────────
// MODULE:    moment-types
// COMPONENT: Hand-written type surface for Obsidian's bundled moment.js global
// ───────────────────────────────────────────────────────────────────
//
...
// No npm package required — moment is provided by the Obsidian runtime, so a
// method declared here without a runtime counterpart would type-check yet
// fail when called. Keep this list in sync with actual call sites, not the
// full moment API.
