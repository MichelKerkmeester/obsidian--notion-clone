// ───────────────────────────────────────────────────────────────────
// MODULE:    template-toolbar-action
// COMPONENT: "New from template" toolbar button — label, tooltip, confirm gate, and create call
// ───────────────────────────────────────────────────────────────────
//
// The confirmation prompt is opt-in and only fires when a template is
// actually configured (hasRecordTemplate) — plain "new record" creation
// must never be interrupted by a confirm dialog just because the caller
// left confirmEnabled on.
