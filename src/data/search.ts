// ───────────────────────────────────────────────────────────────────
// MODULE:    search
// COMPONENT: Table search matching, including locale-aware partial-date queries.
// ───────────────────────────────────────────────────────────────────
//
// Date/datetime columns are matched two ways: against their visible display
// text, and against explicit partial-date query forms (full "y-m-d", "y-m",
// or "m-d"). Raw Date values are never stringified via toISOString() for this
// — that can contain timezone-shifted digits the user never sees on screen
// (e.g. local midnight rendered as a different UTC date). Highlight terms are
// generated separately via Intl so the highlighted span matches what the
// display formatter actually rendered, not the query's own literal digits.
