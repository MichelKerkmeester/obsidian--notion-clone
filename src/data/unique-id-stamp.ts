// ───────────────────────────────────────────────────────────────────
// MODULE:    unique-id-stamp
// COMPONENT: allocates stable create-time record identities (prefix + zero-padded counter)
// ───────────────────────────────────────────────────────────────────
//
// Identities are derived from a persisted counter, not the note filename or
// any runtime service, so renaming or moving a file never changes its
// stamped id. Every numeric input is re-validated defensively (parse and
// next both guard against a negative/non-finite counter or pad width) since
// config can arrive from hand-edited or imported frontmatter.
