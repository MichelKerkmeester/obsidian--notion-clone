// ───────────────────────────────────────────────────────────────────
// MODULE:    column-display.test
// COMPONENT: locks isEmptyValue and the Reports empty-placeholder exemption
// ───────────────────────────────────────────────────────────────────

import { describe, expect, it } from "vitest";
import { getColumnDisplayType, isEmptyValue } from "./column-display";
import { isReportsComputedColumn } from "./reports-display";
...
// ───────────────────────────────────────────────────────────────────
// 2. EMPTY-VALUE PLACEHOLDER GUARD
// ───────────────────────────────────────────────────────────────────
