...
// COMPONENT: Maps keyboard events to spreadsheet navigation intents and resolves them against the grid.
// ───────────────────────────────────────────────────────────────────
//
// Horizontal movement (Tab/next/previous) wraps across row boundaries; vertical
