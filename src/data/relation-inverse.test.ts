// ───────────────────────────────────────────────────────────────────
// MODULE:    relation-inverse.test
// COMPONENT: regression suite for the inverse relation index and its rollup consumer
// ───────────────────────────────────────────────────────────────────
//
// Covers the traps unique to inverse resolution: dangling/cross-database
// links must not appear inbound, a self-relation must not recursively
// expand, aliases/subpaths must be stripped before resolving, and a rollup
// falling back to inverse resolution must not shadow a same-named local
// relation column.
...
import { buildRelationRollups } from "./relation-rollup";
import type { RelationRollupContext } from "./relation-rollup";
