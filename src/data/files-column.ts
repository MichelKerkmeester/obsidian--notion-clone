// ───────────────────────────────────────────────────────────────────
// MODULE:    files-column
// COMPONENT: vault-local "files" column — parse, normalize, and render
// ───────────────────────────────────────────────────────────────────
//
...
// Malformed link-like text (`[[broken`, unmatched markdown links) is kept
// visible as a harmless text chip instead of being dropped or promoted to a
// phantom vault link, and any explicit URL scheme is discarded outright so
// this column never becomes a `javascript:`/`file:` open vector.
...
import { isImageTarget as isCoverImageTarget } from "./cover-image";
import { hasUrlScheme, getLinkLabel } from "./text-link";
