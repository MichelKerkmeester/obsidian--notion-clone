...
// COMPONENT: Pure display math for the rating-star and progress-bar/ring number styles
// ───────────────────────────────────────────────────────────────────
//
// No DOM/Obsidian deps — unit-testable. Every function is total over its
// numeric domain (non-finite input resolves to an empty/zero result rather
// than NaN/Infinity leaking into rendered markup or SVG path data).
