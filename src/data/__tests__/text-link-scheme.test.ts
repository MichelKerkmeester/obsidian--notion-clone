// ───────────────────────────────────────────────────────────────────
// MODULE:    text-link-scheme.test
// COMPONENT: link-target assembly and scheme-allowlist regression suite
// ───────────────────────────────────────────────────────────────────
//
// assembleSchemeLinkTarget builds an href from user text under a fixed
// scheme (https/mailto/tel); the allowlist and rejection paths here exist
// to stop a "javascript:" or other unexpected-scheme value from surviving
// into a rendered link, and to keep length/whitespace/control-character
// inputs from producing a target the renderer would choke on.
...
import { assembleSchemeLinkTarget, isTextLinkScheme } from "../text-link-scheme";
