// ───────────────────────────────────────────────────────────────────
// MODULE:    board-container-drop
// COMPONENT: board drag/drop target resolution for column/subgroup empty-space and card-on-card drops
// ───────────────────────────────────────────────────────────────────
//
// 看板容器拖拽目标决策。
//
...
import { isEmptyGroupId } from "./multi-select";
import { stringifyValue } from "./stringify";

// ───────────────────────────────────────────────────────────────────
// 2. CONTAINER DROP ORDER
// ───────────────────────────────────────────────────────────────────
