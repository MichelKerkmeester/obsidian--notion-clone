// ───────────────────────────────────────────────────────────────────
// MODULE:    icon-picker-catalog
// COMPONENT: Static emoji + Lucide catalog data consumed by the icon picker popover
// ───────────────────────────────────────────────────────────────────
//
// Lucide categories match icons by keyword substring against the icon id
// (e.g. "chevron" catches every chevron-* icon), not by an exhaustive id
// list — new Lucide icons that fit an existing keyword fall into the right
// category automatically instead of silently landing in "other". The
// "common" category is the one exception: it uses an explicit `ids` list
// because it curates a hand-picked shortlist rather than a keyword family.
