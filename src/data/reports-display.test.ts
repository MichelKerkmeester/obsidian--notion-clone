// ───────────────────────────────────────────────────────────────────
// MODULE:    reports-display.test
// COMPONENT: regression suite for Reports computed-column detection and number formatting
// ───────────────────────────────────────────────────────────────────
//
// Pins that isReportsComputedColumn only matches the two Reports-managed
// keys (remaining/saved) and not an unrelated user-defined computed column
// with a similar shape, and that formatReportsNumber fails closed (renders
// "-") for null/NaN/Infinity instead of printing a misleading number.
...
import { formatReportsNumber, isReportsComputedColumn } from "./reports-display";
