// ───────────────────────────────────────────────────────────────────
// MODULE:    reports-inspector
// COMPONENT: Read-only inspection and expression-lock helpers for live Reports db_views.
// ───────────────────────────────────────────────────────────────────
//
// Deliberately has no Obsidian or persistence dependencies. It captures the
// parsed payload and builds native formula expressions only after a caller
// provides the inspected SUM-rollup column references, which keeps the
// operation display-only and rebase-safe (nothing here writes back to the
// database config).
