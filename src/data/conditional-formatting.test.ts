// ───────────────────────────────────────────────────────────────────
// MODULE:    conditional-formatting.test
// COMPONENT: Coverage for rule-order precedence, tree evaluation and icon/style painting
// ───────────────────────────────────────────────────────────────────
...
import { getEffectiveFilterRules } from "./filter-rules";
import { applyConditionalFormat, getConditionalFormatMatch } from "./conditional-formatting";
import type {
  ColumnDef,
