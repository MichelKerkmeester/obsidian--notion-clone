// ───────────────────────────────────────────────────────────────────
// MODULE:    multi-field-grouping
// COMPONENT: Builds and flattens the nested group tree for multi-field grouping
// ───────────────────────────────────────────────────────────────────
//
...
// `dropComputedGroupFields` has to run before `buildGroupTree` recurses,
// because computed/rollup fields have no stable per-row value to group by —
// letting one through would recurse forever or silently bucket every row
// into a single group.
