...
const en: Dictionary = {
  ...
  "notice.galleryMigrated": "\"{name}\" was a gallery. Gallery views are being retired, so it now shows as a board with the same cover image. Undo to keep it a gallery.",
