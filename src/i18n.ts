...
const en: Dictionary = {
  ...
  "optionColor.gray": "Gray",
  "optionColor.brown": "Brown",
  "optionColor.orange": "Orange",
  "optionColor.yellow": "Yellow",
  "optionColor.green": "Green",
  "optionColor.blue": "Blue",
  "optionColor.purple": "Purple",
  "optionColor.pink": "Pink",
  "optionColor.red": "Red",
  "optionColor.slate": "Slate",
  "optionColor.cyan": "Cyan",
  "optionColor.teal": "Teal",
  "optionColor.lime": "Lime",
  "optionColor.indigo": "Indigo",
  "optionColor.violet": "Violet",
  "optionColor.rose": "Rose",
  ...
  "common.empty": "Empty",
  "field.emptySelectPrompt": "Select option",
  "field.emptyMultiSelectPrompt": "Select options",
  "field.emptyRelationPrompt": "Select options",
  "field.emptyNumberPrompt": "Enter number",
  "field.emptyDatePrompt": "Select date",
  "field.emptyDatetimePrompt": "Select date and time",
  "field.emptyCurrencyPrompt": "Enter amount",
  "field.emptyTextPrompt": "Enter text",
  "field.emptyFilesPrompt": "Add file",
  ...
  "subtask.collapse": "Collapse subtasks",
  "subtask.expand": "Expand subtasks",
  "subtask.addPlaceholder": "Add subtask…",
  "subtask.addLabel": "Add subtask to {parent}",
  "subtask.progressSummary": "{done}/{total} subtasks complete",
  "subtask.explicitProgress": "Explicit progress: {value}%",
  "subtask.moveToRoot": "Move to root",
  "subtask.moveUnder": "Move under",
  "subtask.moveCycle": "Cannot move a subtask under itself or its descendant.",
  "subtask.moveUnavailable": "This subtask position is no longer available.",
  "subtask.moveSaveFailed": "Could not save the subtask move.",
  "board.columnOptions": "Column options",
  "board.manageGroups": "Manage groups",
  "board.hideAllGroups": "Hide all",
  "board.showAllGroups": "Show all",
  "board.hideEmptyGroups": "Hide empty groups",
  "board.sortAscending": "Sort ascending",
  "board.sortDescending": "Sort descending",
  "board.subtask": "Subtask",
  "board.milestone": "Milestone",
  "board.recurrence": "Recurring",
  "board.noValue": "No value",
  ...
  "calendar.newNoteForDate": "New note",
  ...
  "changelog.releaseNotes": "## What's new in {version}\n\n- **Much faster tables:** large tables now open in a fraction of the time they used to.\n- **Dropdowns land where you expect:** menus stay inside the editing area instead of sliding under the right sidebar, and size to their contents rather than stretching wide.\n- **Bottom sheets on phones:** dialogs dock to the bottom of the screen instead of floating as centred desktop windows.\n- **Consistent menus:** every menu row now shares one layout — icon, label, current value, submenu arrow.\n- **Smaller things:** set a column width by typing a pixel value, square checkboxes in boolean cells, a reworked selection bar, and a distinct icon for Files columns.\n\nYour notes and relationships remain ordinary local Markdown and Obsidian wikilinks.",
  ...
  "toolbar.addViewOptions": "Options",
  "toolbar.addViewCreate": "Create",
  "toolbar.copyCurrentViewSettings": "Copy settings from current view",
  ...
  "toolbar.newRowPresets": "New note presets",
  ...
  "toolbar.appliedCount": "{count} applied",
  "toolbar.noFilters": "No filters",
  "toolbar.noSorts": "No sorts",
  "toolbar.noHiddenProperties": "All visible",
  "toolbar.noConditionalColors": "No color rules",
  "toolbar.sortConflictTitle": "Clear sort to reorder?",
  "toolbar.sortConflictMessage": "This view is sorted. Reordering will clear the sort and keep the new order.",
  "toolbar.sortConflictConfirm": "Clear sort",
  "toolbar.presetNone": "—",
  "viewConfig.filters": "Filters",
  "viewConfig.sorts": "Sorts",
  "viewConfig.properties": "Properties",
  "viewConfig.conditionalColor": "Conditional color",
  "viewConfig.conditionalColorHint": "Colors a row's background where its rules match. Set the rules below.",
  "toolbar.group": "Group",
  ...
  "toolbar.createLinkedView": "Create linked view",
  "toolbar.moveToPage": "Move to page…",
  "linkedView.title": "Create linked view",
  "linkedView.sourceDatabase": "Source database",
  "linkedView.viewType": "View type",
  "linkedView.name": "Name",
  "linkedView.namePlaceholder": "Optional name",
  "linkedView.create": "Create",
  "linkedView.pickPage": "Move linked view to page",
  ...
  "command.createLinkedView": "Note database: Create linked view",
  "command.copySheetTrace": "Note database: Copy sheet trace",
  "settings.debugSheetTrace.name": "Trace sheet lifecycle",
  "settings.debugSheetTrace.desc": "Record what happens to phone bottom sheets — taps, rebuilds, dismissals and viewport changes — so a defect that only appears on a device can be reported. Off by default and inert while off. Records element tags and classes only, never note content. Use the \"Copy sheet trace\" command to put the log on the clipboard.",
  ...
  "undo.deleteViewConfig": "delete view",
  "undo.galleryMigration": "gallery view migration",
  "undo.timelineMigration": "timeline view migration",
  ...
  "undo.freezeColumnConfig": "freeze column",
  ...
  "undo.timelineLocalExtensionsConfig": "timeline local extensions",
  "undo.timelineWeekLabelConfig": "timeline week label",
  ...
  "undo.deleteRow": "delete entry",
  "undo.moveLinkedView": "move linked view",
  ...
  "undo.wrapTextConfig": "wrap text",
  "undo.addRowNounConfig": "add-row noun",
  ...
  "panel.addAdvancedFilter": "Add advanced filter",
  "panel.addSort": "Add sort",
  "panel.emptyFilters": "Tap \"Add condition\" to start filtering.",
  "panel.emptySorts": "Tap \"Add sort\" to add multi-sort rules.",
  "sortPanel.calendarHint": "Spanning, all-day and overlapping events sort first; rules order the rest.",
  "panel.and": "AND (all)",
  "panel.or": "OR (any)",
  "panel.field": "Property",
  "panel.operator": "Operator",
  "panel.sortDirection": "Direction",
  "panel.value": "Value",
  "panel.all": "All",
  "panel.addColumn": "Add property",
  "panel.addPropertySearchPlaceholder": "Search or create new",
  "panel.searchProperties": "Search properties",
  "panel.createPropertyNamed": "Create \"{name}\"",
  "panel.createProperty": "Create property…",
  "panel.dragToSort": "Drag to reorder",
  "panel.doubleClickEdit": "Double-tap to edit",
  ...
  "panel.noteBodyPlaceholder": "Write a note…",
  ...
  "panel.hiddenProperties": "Hidden properties ({count})",
  "panel.shownSection": "Shown",
  "panel.hiddenSection": "Hidden",
  /** The Properties sheet's own section headings, distinct from `panel.shownSection`/`hiddenSection`
   *  above (shared by the record sheet's hidden-properties group and the board's group-by picker,
   *  where an "in table" suffix would misdescribe a different surface). */
  "panel.shownInTable": "Shown in table",
  "panel.hiddenInTable": "Hidden in table",
  "panel.hideAllProperties": "Hide all",
  "panel.showAllProperties": "Show all",
  "viewConfig.title": "View settings",
  "viewConfig.databaseSection": "Current database",
  "viewConfig.viewSection": "Current view",
  "viewConfig.displaySection": "Display",
  "viewConfig.manageStatusPresets": "Manage status presets",
  "viewConfig.viewSourceRules": "Enable this view's source rules",
  "viewConfig.viewSourceRulesHint": "When on, these rules combine with the database's rules; off applies neither.",
  ...
  "viewConfig.wrapText": "Wrap text",
  "viewConfig.addRowNoun": "Add-row noun",
  "viewConfig.addRowNoun.placeholder": "New",
  ...
  "viewConfig.databaseReadonly": "Read-only here. Open the full database view to change these settings.",
  ...
  "propertyConflict.typeNotAvailable": "Not available for this property",
  "propertyConflict.computedOnlyPlainTypes": "A computed field can only resolve to a plain type",
  ...
  "timeline.linkInput": "Dependency input",
  "timeline.linkOutput": "Dependency output",
  "timeline.linkStart": "Start dependency link",
  "timeline.linkSameSide": "Connect a right dot (output) to a left dot (input).",
  "timeline.linkDuplicate": "This dependency already exists.",
  "timeline.linkMissingTask": "That task is no longer in this view.",
  "timeline.linkCycle": "That link would create a dependency cycle.",
  "timeline.linkCreated": "Dependency link created.",
  "timeline.linkSaveFailed": "Failed to save dependency.",
  "timeline.linkUnavailable": "Dependency links are unavailable in this view.",
  "timeline.columnWidth": "Column width",
  "timeline.layoutSection": "Layout",
  "timeline.jumpToEvent": "Jump to {title} on {date}",
  "timeline.taskColumn": "Task",
  "timeline.addTask": "Add task",
  "timeline.addSubtask": "Add subtask",
  "timeline.expandAll": "Expand all",
  "timeline.collapseAll": "Collapse all",
  "timeline.clickToSetDates": "Click to set dates",
  "timeline.dependsElsewhere": "Depends on {count} elsewhere",
  "timeline.dateSaveFailed": "Failed to save date change. Please try again.",
  "timeline.barTooltip": "{title}\n{status} · {priority}\nStart: {start}  Due: {due}\nProgress: {progress}%",
  "timeline.barTooltipAssignees": "\nAssignees: {names}",
  "timeline.milestoneTooltip": "{title} (milestone)\nDate: {date}",
  "viewConfig.customColumnWidth": "Custom column width",
  "viewConfig.timelineLocalExtensions": "Local extensions",
  ...
  "viewConfig.timelineWeekLabel": "Week label",
  "viewConfig.timelineWeekLabel.weekNumber": "Week number",
  "viewConfig.timelineWeekLabel.dateRange": "Date range",
  "viewConfig.timelineWeekLabel.both": "Week number + date range",
  ...
  "viewConfig.sourceRules.help": "Advanced rules decide which notes belong here; groups survive .base imports.",
  "viewConfig.sourceRules.empty": "No advanced source rules.",
  "viewConfig.sourceRules.none": "None",
  ...
  "viewConfig.newRecordFolder.sameAsSource": "Same as source",
  "viewConfig.newRecordFolderLocked": "Where new notes go. Empty uses the source folder, then the database default.",
  ...
  "viewConfig.computedSync.displayOnlyDesc": "Values show in the database but never create or update note properties.",
  "viewConfig.computedSync.automatic": "Automatically save to note properties",
  "viewConfig.computedSync.automaticDesc": "Formula results can update many notes when this database opens or changes.",
  "viewConfig.computedSync.manual": "Save to note properties manually",
  "viewConfig.computedSync.manualDesc": "Use the toolbar button when a plugin, export, or Dataview needs the results.",
  "viewConfig.computedSync.help": "Formulas always calculate for display; this only controls saving to notes.",
  "viewConfig.computedSync.confirmAutomatic": "This can modify many notes in this database scope.\n\nContinue?",
  "viewConfig.computedSync.manualHint": "Formula values will stay display-only until you tap “Save formula results”.",
  "viewConfig.computedSync.displayOnlyHint": "Saved formula properties will be kept, but Obnotion will stop updating them.",
  ...
  "viewConfig.cardProperties": "Properties",
  ...
  "viewConfig.titleFormat": "Title format",
  "viewConfig.titleFormat.text": "Plain text",
  "viewConfig.titleFormat.number": "Number",
  "viewConfig.titleFormat.currencyEur": "Currency (EUR)",
  "viewConfig.titleFormat.currencyUsd": "Currency (USD)",
  "viewConfig.titleFormat.currencyGbp": "Currency (GBP)",
  "viewConfig.titleFormat.date": "Date",
  "viewConfig.titleFormat.hint": "Applies while the title is the note's name; a chosen column keeps its own.",
  ...
  "menu.title": "Menu",
  "menu.noActions": "No available actions",
  "menu.back": "← Back",
  ...
  "menu.freezeColumn": "Freeze up to this column",
  "menu.columnWrap": "Wrap text",
  "menu.columnWrapOn": "Wrap",
  "menu.columnWrapOff": "Clip",
  "menu.columnWrapFollow": "Follow view",
  "menu.columnWrapNeedsViewSwitch": "View switch is off",
  ...
  "menu.cardTitle": "Card title",
  "menu.duplicateRecord": "Duplicate record",
  "menu.copySuffix": "copy",
  "settings.title": "Obnotion settings",
  ...
  "settings.recordOpenTarget.name": "Where a record opens",
  "settings.recordOpenTarget.desc": "Used by every way of opening a record — a title, an Open button, a keyboard shortcut, a context menu. Each one used to decide for itself, so the same icon opened two different things.",
  "settings.recordOpenTarget.option.panel": "Record panel",
  "settings.recordOpenTarget.option.peek": "Preview layer",
  "settings.recordOpenTarget.option.tab": "Current tab",
  "settings.recordOpenTarget.option.split": "Split pane",
  "settings.recordOpenTarget.option.window": "New window",
  "settings.defaultView.name": "Default view for new databases",
  "settings.defaultView.desc": "View type a newly created database opens with. Existing databases keep their own views.",
  ...
  "csvMarkdownImport.desc": "Select the summary CSV file (named *_all.csv) exported by this plugin for best results. You may also select individual view CSV files. Optionally add Markdown files and obnotion.json metadata.",
  ...
  "csvMarkdownExport.desc": "The ZIP contains a CSV file, one Markdown file per row, and obnotion.json metadata for re-importing the database structure.",
  ...
  "formula.resultTypeNotComputable": "A formula cannot resolve to this type",
  ...
  "date.endBeforeStartHint": "If the end date is earlier than the start, the start date is used.",
  ...
  "errors.unsupportedBaseFilters": "This .base file uses a global filter expression that Obnotion cannot convert without changing its meaning.",
  "notice.galleryMigrated": "\"{name}\" was a gallery. Gallery views are being retired, so it now shows as a board with the same cover image, fit and aspect ratio. Its card-size settings do not carry over. Undo to keep it a gallery.",
  "notice.listMigrated": "\"{name}\" is a list view. List views are being retired, so it now opens as a table with the same columns.",
  "notice.chartMigrated": "\"{name}\" is a chart view. Chart views are being retired, so it now opens as a table with the underlying records. Its aggregation, bucketing and reference-line settings do not carry over.",
  "notice.calendarMigrated": "\"{name}\" is a calendar view. Calendar views are being retired, so it now opens as a table sorted by the same date property. Its grid arrangement, end dates and title/color formatting do not carry over.",
  "notice.timelineMigrated": "\"{name}\" was a timeline. Timeline views are being retired, so it now shows as a board with the same lane grouping. Its date-axis and start/end date settings do not carry over. Undo to keep it a timeline.",
  ...
  "notice.undoSuperseded": "Can't undo that deletion — a newer edit is on top of the history",
  ...
  "notice.deletedView": "Deleted view: {name}",
  ...
  "notice.linkedViewCreated": "Linked view created",
  "notice.linkedViewMoved": "Linked view moved",
  "notice.linkedViewMoveFailed": "Could not move the linked view",
  "notice.linkedViewNoEditor": "Open a note to insert the linked view",
  "notice.linkedViewNoDatabase": "No source database to link",
  ...
  "empty.createFirstDatabase": "Create your first Obnotion",
  ...
  "emptyState.groupRelationDeletedTitle": "Grouping property no longer exists",
  "emptyState.groupRelationDeletedMessage": "The property this board groups by was removed. Choose a new one in view settings.",
  "emptyState.openViewSettings": "Open view settings",
  "emptyState.sourceMissingTitle": "This view's source is missing",
  "emptyState.sourceMissingMessage": "The folder or database this view pointed to was moved or deleted. Choose a database to continue.",
  "emptyState.chooseDatabase": "Choose database",
  "embeddedTable.loadMore": "Load {count} more",
  ...
  "columnType.createdBy": "Created by",
  "columnType.lastEditedTime": "Last edited time",
  "columnType.lastEditedBy": "Last edited by",
  "toolbar.newNoun": "New {noun}",
  ...
  "viewConfig.calendarFirstDayOfWeek.auto": "Monday (default)",
...
const zhCN: Dictionary = {
  ...
  "optionColor.pink": "粉色",
  "optionColor.red": "红色",
  "optionColor.slate": "石板灰",
  "optionColor.cyan": "青色",
  "optionColor.teal": "青绿色",
  "optionColor.lime": "青柠色",
  "optionColor.indigo": "靛蓝色",
  "optionColor.violet": "紫罗兰色",
  "optionColor.rose": "玫瑰色",
  ...
  "common.empty": "空",
  "field.emptySelectPrompt": "选择选项",
  "field.emptyMultiSelectPrompt": "选择选项",
  "field.emptyRelationPrompt": "选择关联",
  "field.emptyNumberPrompt": "输入数字",
  "field.emptyDatePrompt": "选择日期",
  "field.emptyDatetimePrompt": "选择日期和时间",
  "field.emptyCurrencyPrompt": "输入金额",
  "field.emptyTextPrompt": "输入文本",
  "field.emptyFilesPrompt": "添加文件",
  "common.database": "数据库",
  ...
  "calendar.unscheduledEmpty": "没有未安排的事项。",
  "board.collapseGroup": "折叠分组",
  "subtask.collapse": "折叠子任务",
  "subtask.expand": "展开子任务",
  "subtask.addPlaceholder": "添加子任务…",
  "subtask.addLabel": "向 {parent} 添加子任务",
  "subtask.progressSummary": "已完成 {done}/{total} 个子任务",
  "subtask.explicitProgress": "显式进度：{value}%",
  "subtask.moveToRoot": "移至根级",
  "subtask.moveUnder": "移至以下项目下",
  "subtask.moveCycle": "无法将子任务移到自身或其后代下。",
  "subtask.moveUnavailable": "子任务位置已不可用。",
  "subtask.moveSaveFailed": "无法保存子任务移动。",
  "board.columnOptions": "列选项",
  "board.manageGroups": "管理分组",
  "board.hideAllGroups": "全部隐藏",
  "board.showAllGroups": "全部显示",
  "board.hideEmptyGroups": "隐藏空分组",
  ...
  "changelog.releaseNotes": "## {version} 更新内容\n\n- **表格大幅提速：** 大型表格的打开时间已缩短到原来的一小部分。\n- **下拉菜单位置正确：** 菜单始终留在编辑区内，不再滑到右侧边栏下方，宽度也会贴合内容而不是一味拉宽。\n- **手机端底部弹层：** 对话框停靠在屏幕底部，不再以桌面端居中窗口的形式出现。\n- **统一的菜单：** 所有菜单行共用同一套排版——图标、名称、当前值、子菜单箭头。\n- **其他改进：** 可直接输入像素值设置列宽、布尔单元格使用方形复选框、重做的多选工具栏，以及 Files 列的独立图标。\n\n笔记与关联仍然只是保存在本地的 Markdown 和 Obsidian 双链。",
  ...
  "toolbar.addViewOptions": "选项",
  "toolbar.addViewCreate": "新建",
  "toolbar.copyCurrentViewSettings": "从当前视图复制设置",
  ...
  "toolbar.view": "视图",
  "toolbar.settings": "设置",
  "toolbar.appliedCount": "已应用 {count} 项",
  "toolbar.noFilters": "无筛选",
  "toolbar.noSorts": "无排序",
  "toolbar.noHiddenProperties": "全部可见",
  "toolbar.sortConflictTitle": "清除排序以重排？",
  "toolbar.sortConflictMessage": "当前视图已排序。重排将清除排序并保留新顺序。",
  "toolbar.sortConflictConfirm": "清除排序",
  "toolbar.presetNone": "—",
  "viewConfig.filters": "筛选",
  "viewConfig.sorts": "排序",
  "viewConfig.properties": "属性",
  "toolbar.group": "分组",
  ...
  "toolbar.createLinkedView": "创建链接视图",
  "toolbar.moveToPage": "移动到页面…",
  "linkedView.title": "创建链接视图",
  "linkedView.sourceDatabase": "源数据库",
  "linkedView.viewType": "视图类型",
  "linkedView.name": "名称",
  "linkedView.namePlaceholder": "可选名称",
  "linkedView.create": "创建",
  "linkedView.pickPage": "将链接视图移动到页面",
  "toolbar.rename": "重命名",
  ...
  "command.createLinkedView": "Note database: 创建链接视图",
  "command.copySheetTrace": "笔记数据库：复制面板跟踪日志",
  "settings.debugSheetTrace.name": "记录面板生命周期",
  "settings.debugSheetTrace.desc": "记录手机底部面板的点击、重建、关闭与视口变化，以便报告仅在设备上出现的问题。默认关闭，关闭时不做任何处理。仅记录元素标签与类名，不记录笔记内容。",
  ...
  "undo.galleryMigration": "画廊视图迁移",
  "undo.timelineMigration": "时间线视图迁移",
  ...
  "undo.timelineLocalExtensionsConfig": "时间线本地扩展",
  "undo.timelineWeekLabelConfig": "时间线周标签",
  ...
  "panel.addSort": "添加排序",
  "panel.emptyFilters": "轻点「添加条件」开始筛选。",
  "panel.emptySorts": "轻点「添加排序」开始多条件排序。",
  "sortPanel.calendarHint": "跨度、全天与重叠时段的事件先排；排序规则决定其余顺序。",
  "panel.and": "AND（全部满足）",
  "panel.or": "OR（任一满足）",
  "panel.field": "属性",
  "panel.operator": "条件",
  ...
  "panel.addPropertySearchPlaceholder": "搜索或创建新属性",
  "panel.searchProperties": "搜索属性",
  "panel.createPropertyNamed": "创建“{name}”",
  "panel.createProperty": "新建属性…",
  "panel.dragToSort": "拖拽排序",
  "panel.doubleClickEdit": "轻点两下编辑属性",
  "panel.wrap": "换行显示完整内容",
  "panel.groupedPropertyHidden": "此属性已用于分组故不会出现在条目内容中",
  "panel.titleFieldHint": "该属性已被用作标题。",
  "panel.noteBodyPlaceholder": "写点什么…",
  "panel.groupFieldHint": "该属性已用于分组故不会出现在条目内容中。",
  "panel.subgroupFieldHint": "该属性已用于子分组故不会出现在条目内容中。",
  "panel.open": "打开",
  "panel.noProperties": "暂无属性",
  "panel.hiddenProperties": "隐藏属性（{count}）",
  "panel.shownSection": "显示中",
  "panel.hiddenSection": "已隐藏",
  "panel.shownInTable": "表格中显示",
  "panel.hiddenInTable": "表格中隐藏",
  "panel.hideAllProperties": "全部隐藏",
  "panel.showAllProperties": "全部显示",
  "viewConfig.title": "视图设置",
  "viewConfig.databaseSection": "当前数据库",
  "viewConfig.viewSection": "当前视图",
  "viewConfig.displaySection": "显示",
  "viewConfig.manageStatusPresets": "管理状态预设",
  ...
  "viewConfig.wrapText": "文本换行",
  "viewConfig.addRowNoun": "新增行名称",
  "viewConfig.addRowNoun.placeholder": "新建",
  ...
  "propertyConflict.typeNotAvailable": "此属性不支持该类型",
  "propertyConflict.computedOnlyPlainTypes": "计算字段只能解析为基础类型",
  ...
  "timeline.scaleYear": "年",
  "timeline.linkInput": "依赖输入",
  "timeline.linkOutput": "依赖输出",
  "timeline.linkStart": "开始创建依赖链接",
  "timeline.linkSameSide": "请将右侧圆点（输出）连接到左侧圆点（输入）。",
  "timeline.linkDuplicate": "此依赖关系已存在。",
  "timeline.linkMissingTask": "该任务已不在此视图中。",
  "timeline.linkCycle": "该链接会创建依赖循环。",
  "timeline.linkCreated": "已创建依赖链接。",
  "timeline.linkSaveFailed": "依赖关系保存失败。",
  "timeline.linkUnavailable": "此视图无法使用依赖链接。",
  "timeline.columnWidth": "列宽",
  "timeline.layoutSection": "布局",
  "timeline.jumpToEvent": "跳转到 {date} 的 {title}",
  "timeline.taskColumn": "任务",
  "timeline.addTask": "添加任务",
  "timeline.addSubtask": "添加子任务",
  "timeline.expandAll": "全部展开",
  "timeline.collapseAll": "全部折叠",
  "timeline.clickToSetDates": "点击设置日期",
  "timeline.dependsElsewhere": "依赖其他 {count} 项",
  "timeline.dateSaveFailed": "保存日期更改失败，请重试。",
  "timeline.barTooltip": "{title}\n{status} · {priority}\n开始：{start}  截止：{due}\n进度：{progress}%",
  "timeline.barTooltipAssignees": "\n负责人：{names}",
  "timeline.milestoneTooltip": "{title}（里程碑）\n日期：{date}",
  "viewConfig.customColumnWidth": "自定义列宽",
  "viewConfig.timelineLocalExtensions": "本地扩展",
  "viewConfig.timelineWeekLabel": "周标签",
  "viewConfig.timelineWeekLabel.weekNumber": "周数",
  "viewConfig.timelineWeekLabel.dateRange": "日期范围",
  "viewConfig.timelineWeekLabel.both": "周数 + 日期范围",
  ...
  "viewConfig.calendarFirstDayOfWeek.auto": "周一（默认）",
  ...
  "viewConfig.newRecordFolder.sameAsSource": "与来源相同",
  ...
  "viewConfig.computedSync.manualDesc": "需要导出、Dataview 或其他插件读取计算结果时，再轻点工具栏按钮保存。",
  ...
  "viewConfig.computedSync.manualHint": "计算结果会先保持仅显示；需要写入笔记属性时，请轻点“保存计算结果”。",
  "viewConfig.computedSync.displayOnlyHint": "已保存的计算属性会保留，但 Obnotion 不会再更新它们。",
  ...
  "viewConfig.titleFormat": "标题格式",
  "viewConfig.titleFormat.text": "纯文本",
  "viewConfig.titleFormat.number": "数字",
  "viewConfig.titleFormat.currencyEur": "货币（欧元）",
  "viewConfig.titleFormat.currencyUsd": "货币（美元）",
  "viewConfig.titleFormat.currencyGbp": "货币（英镑）",
  "viewConfig.titleFormat.date": "日期",
  "viewConfig.titleFormat.hint": "仅在标题取自笔记名称时套用；选择属性作为标题后，将沿用该属性自身的格式。",
  ...
  "menu.freezeColumn": "冻结到此列",
  "menu.columnWrap": "文本换行",
  "menu.columnWrapOn": "换行",
  "menu.columnWrapOff": "截断",
  "menu.columnWrapFollow": "跟随视图",
  "menu.columnWrapNeedsViewSwitch": "视图开关已关闭",
  ...
  "menu.renameNote": "重命名笔记",
  "menu.cardTitle": "卡片标题",
  "menu.duplicateRecord": "复制记录",
  "menu.copySuffix": "副本",
  "settings.title": "Obnotion 设置",
  ...
  "settings.recordOpenTarget.name": "记录的打开位置",
  "settings.recordOpenTarget.desc": "所有打开记录的方式都使用此设置——标题、打开按钮、快捷键、右键菜单。以前每种方式各自决定，因此同一个图标会打开两种不同的界面。",
  "settings.recordOpenTarget.option.panel": "记录面板",
  "settings.recordOpenTarget.option.peek": "预览层",
  "settings.recordOpenTarget.option.tab": "当前标签页",
  "settings.recordOpenTarget.option.split": "分屏",
  "settings.recordOpenTarget.option.window": "新窗口",
  "settings.defaultView.name": "新建数据库的默认视图",
  "settings.defaultView.desc": "新建数据库默认打开的视图类型。已有数据库保留各自的视图。",
  ...
  "csvMarkdownImport.desc": "请优先选择本插件导出的汇总 CSV 文件（名为 *_all.csv），也可以选择各视图的独立 CSV 文件。可选添加 Markdown 文件和 obnotion.json 元数据以完整恢复数据库结构。",
  ...
  "csvMarkdownExport.desc": "ZIP 内包含 CSV、每条记录对应的 Markdown 文件，以及用于重新导入数据库结构的 obnotion.json。",
  ...
  "formula.resultTypeNotComputable": "公式无法解析为该类型",
  ...
  "date.endDate": "结束日期",
  "date.endBeforeStartHint": "若结束日期早于开始日期，将以开始日期为准。",
  ...
  "errors.unsupportedBaseFilters": "此 .base 文件使用了 Obnotion 无法在不改变含义的前提下转换的全局筛选表达式。",
  ...
  "notice.galleryMigrated": "“{name}”曾是画廊视图。画廊视图正在退役，因此现在以看板视图显示，封面图片、填充方式和长宽比保持不变，但卡片大小设置不会保留。撤销可恢复为画廊视图。",
  "notice.listMigrated": "“{name}”曾是列表视图。列表视图正在退役，因此现在以表格视图打开，列设置保持不变。",
  "notice.chartMigrated": "“{name}”曾是图表视图。图表视图正在退役，因此现在以表格视图打开，显示原始记录，但聚合、分组和参考线设置不会保留。",
  "notice.calendarMigrated": "“{name}”曾是日历视图。日历视图正在退役，因此现在以表格视图打开，并按相同的日期属性排序，但网格布局、结束日期以及标题/颜色格式不会保留。",
  "notice.timelineMigrated": "“{name}”曾是时间线视图。时间线视图正在退役，因此现在以看板视图显示，分组保持不变，但时间轴及开始/结束日期设置不会保留。撤销可恢复为时间线视图。",
  ...
  "notice.undoSuperseded": "无法撤销该删除：历史记录顶部已有更新的操作",
  ...
  "notice.linkedViewCreated": "已创建链接视图",
  "notice.linkedViewMoved": "已移动链接视图",
  "notice.linkedViewMoveFailed": "无法移动链接视图",
  "notice.linkedViewNoEditor": "请打开笔记以插入链接视图",
  "notice.linkedViewNoDatabase": "没有可链接的源数据库",
  ...
  "empty.createFirstDatabase": "创建自己的第一个 Obnotion",
  "empty.noColumnsDb": "数据库「{name}」没有配置列。请在设置中添加至少一个属性列。",
  "emptyState.noDateFieldTitle": "未设置日期属性",
  "emptyState.noDateFieldMessage": "请选择为本视图提供日期的属性。",
  "emptyState.noEventsTitle": "暂无事件",
  "emptyState.noEventsMessage": "在所选日期属性中有值的记录会显示在这里。",
  "emptyState.sourceMissingTitle": "此视图的来源已丢失",
  "emptyState.sourceMissingMessage": "此视图所指向的文件夹或数据库已被移动或删除。选择一个数据库以继续。",
  "emptyState.chooseDatabase": "选择数据库",
  ...
  "columnType.email": "邮箱",
  "columnType.phone": "电话",
  "columnType.person": "人员",
  "columnType.createdTime": "创建时间",
  "columnType.createdBy": "创建者",
  "columnType.lastEditedTime": "最后编辑时间",
  "columnType.lastEditedBy": "最后编辑者",
  "toolbar.newNoun": "新建{noun}",
...
const zhTW: Dictionary = {
  ...
  "optionColor.brown": "棕色",
  "optionColor.orange": "橙色",
  "optionColor.yellow": "黃色",
  "optionColor.green": "綠色",
  "optionColor.blue": "藍色",
  "optionColor.purple": "紫色",
  "optionColor.pink": "粉色",
  "optionColor.red": "紅色",
  "optionColor.slate": "石板灰",
  "optionColor.cyan": "青色",
  "optionColor.teal": "青綠色",
  "optionColor.lime": "萊姆綠",
  "optionColor.indigo": "靛藍色",
  "optionColor.violet": "紫羅蘭色",
  "optionColor.rose": "玫瑰色",
  ...
  "columnType.files": "檔案",
  "columnType.url": "網址",
  "columnType.email": "電子郵件",
  "columnType.phone": "電話",
  "columnType.person": "人員",
  "columnType.createdTime": "建立時間",
  "columnType.createdBy": "建立者",
  "columnType.lastEditedTime": "最後編輯時間",
  "columnType.lastEditedBy": "最後編輯者",
  "toolbar.newNoun": "新增{noun}",
  ...
  "common.empty": "空",
  "field.emptySelectPrompt": "選擇選項",
  "field.emptyMultiSelectPrompt": "選擇選項",
  "field.emptyRelationPrompt": "選擇關聯",
  "field.emptyNumberPrompt": "輸入數字",
  "field.emptyDatePrompt": "選擇日期",
  "field.emptyDatetimePrompt": "選擇日期和時間",
  "field.emptyCurrencyPrompt": "輸入金額",
  "field.emptyTextPrompt": "輸入文字",
  "field.emptyFilesPrompt": "新增檔案",
  "common.database": "資料庫",
  ...
  "calendar.unscheduledEmpty": "沒有未排程的事項。",
  "board.collapseGroup": "摺疊分組",
  "subtask.collapse": "摺疊子任務",
  "subtask.expand": "展開子任務",
  "subtask.addPlaceholder": "新增子任務…",
  "subtask.addLabel": "將子任務新增到 {parent}",
  "subtask.progressSummary": "已完成 {done}/{total} 個子任務",
  "subtask.explicitProgress": "明確進度：{value}%",
  "subtask.moveToRoot": "移至根層級",
  "subtask.moveUnder": "移至以下項目下",
  "subtask.moveCycle": "無法將子任務移到自身或其後代下。",
  "subtask.moveUnavailable": "子任務位置已不可用。",
  "subtask.moveSaveFailed": "無法儲存子任務移動。",
  "board.columnOptions": "欄選項",
  "board.manageGroups": "管理分組",
  "board.hideAllGroups": "全部隱藏",
  "board.showAllGroups": "全部顯示",
  "board.hideEmptyGroups": "隱藏空分組",
  ...
  "calendar.openNote": "開啟筆記",
  "calendar.newNoteForDate": "新增筆記",
  ...
  "changelog.releaseNotes": "## {version} 更新內容\n\n- **表格大幅提速：** 大型表格的開啟時間已縮短到原來的一小部分。\n- **下拉選單位置正確：** 選單始終留在編輯區內，不再滑到右側邊欄下方，寬度也會貼合內容而不是一味拉寬。\n- **手機端底部彈層：** 對話框停靠在螢幕底部，不再以桌面端置中視窗的形式出現。\n- **統一的選單：** 所有選單列共用同一套排版——圖示、名稱、目前值、子選單箭頭。\n- **其他改進：** 可直接輸入像素值設定欄寬、布林儲存格使用方形核取方塊、重做的多選工具列，以及 Files 欄的獨立圖示。\n\n筆記與關聯仍然只是儲存在本機的 Markdown 和 Obsidian 雙鏈。",
  ...
  "toolbar.addViewOptions": "選項",
  "toolbar.addViewCreate": "新增",
  "toolbar.copyCurrentViewSettings": "從目前檢視複製設定",
  ...
  "toolbar.view": "檢視",
  "toolbar.settings": "設定",
  "toolbar.appliedCount": "已套用 {count} 項",
  "toolbar.noFilters": "無篩選",
  "toolbar.noSorts": "無排序",
  "toolbar.noHiddenProperties": "全部可見",
  "toolbar.sortConflictTitle": "清除排序以重排？",
  "toolbar.sortConflictMessage": "目前檢視已排序。重排將清除排序並保留新順序。",
  "toolbar.sortConflictConfirm": "清除排序",
  "toolbar.presetNone": "—",
  "viewConfig.filters": "篩選",
  "viewConfig.sorts": "排序",
  "viewConfig.properties": "屬性",
  "toolbar.group": "分組",
  ...
  "notice.undoSuperseded": "無法復原該刪除：歷史紀錄頂部已有更新的操作",
  ...
  "toolbar.createLinkedView": "建立連結檢視",
  "toolbar.moveToPage": "移動到頁面…",
  "linkedView.title": "建立連結檢視",
  "linkedView.sourceDatabase": "來源資料庫",
  "linkedView.viewType": "檢視類型",
  "linkedView.name": "名稱",
  "linkedView.namePlaceholder": "可選名稱",
  "linkedView.create": "建立",
  "linkedView.pickPage": "將連結檢視移動到頁面",
  "toolbar.rename": "重新命名",
  ...
  "command.createLinkedView": "Note database: 建立連結檢視",
  "command.copySheetTrace": "筆記資料庫：複製面板追蹤日誌",
  "settings.debugSheetTrace.name": "記錄面板生命週期",
  "settings.debugSheetTrace.desc": "記錄手機底部面板的點擊、重建、關閉與視口變化，以便回報僅在裝置上出現的問題。預設關閉，關閉時不做任何處理。僅記錄元素標籤與類名，不記錄筆記內容。",
  ...
  "undo.galleryMigration": "圖庫檢視遷移",
  "undo.timelineMigration": "時間線檢視遷移",
  ...
  "undo.timelineLocalExtensionsConfig": "時間線本地擴充",
  "undo.timelineWeekLabelConfig": "時間線週標籤",
  ...
  "panel.addSort": "新增排序",
  "panel.emptyFilters": "輕點「新增條件」開始篩選。",
  "panel.emptySorts": "輕點「新增排序」開始多條件排序。",
  ...
  "panel.addPropertySearchPlaceholder": "搜尋或建立新屬性",
  "panel.searchProperties": "搜尋屬性",
  "panel.createPropertyNamed": "建立「{name}」",
  "panel.createProperty": "新建屬性…",
  "panel.dragToSort": "拖曳排序",
  "panel.doubleClickEdit": "輕點兩下編輯屬性",
  "panel.wrap": "換行顯示完整內容",
  "panel.groupedPropertyHidden": "此屬性已用於分組故不會出現在條目內容中",
  "panel.titleFieldHint": "該屬性已被用作標題。",
  "panel.noteBodyPlaceholder": "寫點什麼…",
  "panel.groupFieldHint": "該屬性已用於分組故不會出現在條目內容中。",
  "panel.subgroupFieldHint": "該屬性已用於子分組故不會出現在條目內容中。",
  "panel.open": "打開",
  "panel.noProperties": "沒有屬性",
  "panel.hiddenProperties": "隱藏屬性（{count}）",
  "panel.shownSection": "顯示中",
  "panel.hiddenSection": "已隱藏",
  "panel.shownInTable": "表格中顯示",
  "panel.hiddenInTable": "表格中隱藏",
  "panel.hideAllProperties": "全部隱藏",
  "panel.showAllProperties": "全部顯示",
  "viewConfig.title": "檢視設定",
  "viewConfig.databaseSection": "目前資料庫",
  "viewConfig.viewSection": "目前檢視",
  "viewConfig.displaySection": "顯示",
  "viewConfig.manageStatusPresets": "管理狀態預設",
  ...
  "viewConfig.wrapText": "文字換行",
  "viewConfig.addRowNoun": "新增列名稱",
  "viewConfig.addRowNoun.placeholder": "新增",
  ...
  "propertyConflict.typeNotAvailable": "此屬性不支援該類型",
  "propertyConflict.computedOnlyPlainTypes": "計算欄位只能解析為基礎類型",
  ...
  "timeline.scaleQuarter": "季",
  "timeline.scaleYear": "年",
  "timeline.linkInput": "相依輸入",
  "timeline.linkOutput": "相依輸出",
  "timeline.linkStart": "開始建立相依連結",
  "timeline.linkSameSide": "請將右側圓點（輸出）連接到左側圓點（輸入）。",
  "timeline.linkDuplicate": "此相依關係已存在。",
  "timeline.linkMissingTask": "該任務已不在此檢視中。",
  "timeline.linkCycle": "該連結會建立相依循環。",
  "timeline.linkCreated": "已建立相依連結。",
  "timeline.linkSaveFailed": "相依關係儲存失敗。",
  "timeline.linkUnavailable": "此檢視無法使用相依連結。",
  "timeline.columnWidth": "列寬",
  "timeline.layoutSection": "版面",
  "timeline.jumpToEvent": "跳轉到 {date} 的 {title}",
  "timeline.taskColumn": "任務",
  "timeline.addTask": "新增任務",
  "timeline.addSubtask": "新增子任務",
  "timeline.expandAll": "全部展開",
  "timeline.collapseAll": "全部摺疊",
  "timeline.clickToSetDates": "點擊設定日期",
  "timeline.dependsElsewhere": "依賴其他 {count} 項",
  "timeline.dateSaveFailed": "儲存日期變更失敗，請重試。",
  "timeline.barTooltip": "{title}\n{status} · {priority}\n開始：{start}  截止：{due}\n進度：{progress}%",
  "timeline.barTooltipAssignees": "\n負責人：{names}",
  "timeline.milestoneTooltip": "{title}（里程碑）\n日期：{date}",
  "viewConfig.customColumnWidth": "自訂列寬",
  "viewConfig.timelineLocalExtensions": "本地擴充",
  "viewConfig.timelineWeekLabel": "週標籤",
  "viewConfig.timelineWeekLabel.weekNumber": "週數",
  "viewConfig.timelineWeekLabel.dateRange": "日期範圍",
  "viewConfig.timelineWeekLabel.both": "週數 + 日期範圍",
  ...
  "viewConfig.calendarFirstDayOfWeek.auto": "週一（預設）",
  ...
  "viewConfig.newRecordFolder.sameAsSource": "與來源相同",
  ...
  "viewConfig.computedSync.manualDesc": "需要匯出、Dataview 或其他外掛讀取計算結果時，再輕點工具列按鈕儲存。",
  ...
  "viewConfig.computedSync.manualHint": "計算結果會先保持僅顯示；需要寫入筆記屬性時，請輕點「儲存計算結果」。",
  "viewConfig.computedSync.displayOnlyHint": "已儲存的計算屬性會保留，但 Obnotion 不會再更新它們。",
  ...
  "viewConfig.titleFormat": "標題格式",
  "viewConfig.titleFormat.text": "純文字",
  "viewConfig.titleFormat.number": "數字",
  "viewConfig.titleFormat.currencyEur": "貨幣（歐元）",
  "viewConfig.titleFormat.currencyUsd": "貨幣（美元）",
  "viewConfig.titleFormat.currencyGbp": "貨幣（英鎊）",
  "viewConfig.titleFormat.date": "日期",
  "viewConfig.titleFormat.hint": "僅在標題取自筆記名稱時套用；選擇屬性作為標題後，將沿用該屬性自身的格式。",
  ...
  "menu.freezeColumn": "凍結至此欄",
  "menu.columnWrap": "文字換行",
  "menu.columnWrapOn": "換行",
  "menu.columnWrapOff": "截斷",
  "menu.columnWrapFollow": "跟隨檢視",
  "menu.columnWrapNeedsViewSwitch": "檢視開關已關閉",
  ...
  "menu.renameNote": "重新命名筆記",
  "menu.cardTitle": "卡片標題",
  "menu.duplicateRecord": "複製記錄",
  "menu.copySuffix": "副本",
  "settings.title": "Obnotion 設定",
  ...
  "settings.recordOpenTarget.name": "記錄的開啟位置",
  "settings.recordOpenTarget.desc": "所有開啟記錄的方式都使用此設定——標題、開啟按鈕、快捷鍵、右鍵選單。以前每種方式各自決定，因此同一個圖示會開啟兩種不同的介面。",
  "settings.recordOpenTarget.option.panel": "記錄面板",
  "settings.recordOpenTarget.option.peek": "預覽層",
  "settings.recordOpenTarget.option.tab": "目前分頁",
  "settings.recordOpenTarget.option.split": "分割窗格",
  "settings.recordOpenTarget.option.window": "新視窗",
  "settings.defaultView.name": "新建資料庫的預設檢視",
  "settings.defaultView.desc": "新建資料庫預設開啟的檢視類型。既有資料庫保留各自的檢視。",
  ...
  "csvMarkdownImport.desc": "請優先選擇本插件匯出的匯總 CSV 檔（名為 *_all.csv），也可以選擇各檢視的獨立 CSV 檔。可選新增 Markdown 檔和 obnotion.json 中繼資料以完整恢復資料庫結構。",
  ...
  "csvMarkdownExport.desc": "ZIP 內包含 CSV、每筆記錄對應的 Markdown 檔，以及用於重新匯入資料庫結構的 obnotion.json。",
  ...
  "empty.createFirstDatabase": "建立自己的第一個 Obnotion",
  ...
  "formula.resultTypeNotComputable": "公式無法解析為該類型",
  "formula.sectionTitle": "公式",
  ...
  "errors.unsupportedBaseFilters": "此 .base 檔案使用了 Obnotion 無法在不改變含義的前提下轉換的全域篩選運算式。",
  "app.name": "Obnotion",
  "cell.addOption": "新增選項",
  "cell.clear": "清空",
  ...
  "date.endDate": "結束日期",
  "date.endBeforeStartHint": "若結束日期早於開始日期，將以開始日期為準。",
  ...
  "emptyState.noDateFieldTitle": "未設定日期屬性",
  "emptyState.noDateFieldMessage": "請選擇為此檢視提供日期的屬性。",
  "emptyState.noEventsTitle": "暫無事件",
  "emptyState.noEventsMessage": "在所選日期屬性中有值的記錄會顯示在這裡。",
  "emptyState.sourceMissingTitle": "此檢視的來源已遺失",
  "emptyState.sourceMissingMessage": "此檢視所指向的資料夾或資料庫已被移動或刪除。選擇一個資料庫以繼續。",
  "emptyState.chooseDatabase": "選擇資料庫",
  ...
  "notice.galleryMigrated": "「{name}」曾是圖庫檢視。圖庫檢視正在退役，因此現在以看板檢視顯示，封面圖片、填充方式和長寬比保持不變，但卡片大小設定不會保留。復原可恢復為圖庫檢視。",
  "notice.listMigrated": "「{name}」曾是清單檢視。清單檢視正在退役，因此現在以表格檢視開啟，欄位設定保持不變。",
  "notice.chartMigrated": "「{name}」曾是圖表檢視。圖表檢視正在退役，因此現在以表格檢視開啟，顯示原始記錄，但聚合、分組和參考線設定不會保留。",
  "notice.calendarMigrated": "「{name}」曾是日曆檢視。日曆檢視正在退役，因此現在以表格檢視開啟，並依相同的日期屬性排序，但網格排列、結束日期以及標題/顏色格式不會保留。",
  "notice.timelineMigrated": "「{name}」曾是時間線檢視。時間線檢視正在退役，因此現在以看板檢視顯示，分組保持不變，但時間軸及開始/結束日期設定不會保留。復原可恢復為時間線檢視。",
  ...
  "notice.linkedViewCreated": "已建立連結檢視",
  "notice.linkedViewMoved": "已移動連結檢視",
  "notice.linkedViewMoveFailed": "無法移動連結檢視",
  "notice.linkedViewNoEditor": "請開啟筆記以插入連結檢視",
  "notice.linkedViewNoDatabase": "沒有可連結的來源資料庫",
