// ───────────────────────────────────────────────────────────────────
// MODULE:    status-preset-manager-modal
// COMPONENT: CRUD editor for reusable status/select option presets, with a protected default
// ───────────────────────────────────────────────────────────────────
//
// Re-renders via `this.onOpen()` after every mutation instead of patching
// the DOM in place, trading a full re-draw for the guarantee that presets,
// default-badge state and the option list can never disagree. Deletion is
// blocked below one preset so a column can never end up with none.
