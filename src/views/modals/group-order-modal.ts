// ───────────────────────────────────────────────────────────────────
// MODULE:    group-order-modal
// COMPONENT: drag-and-drop editor for a board/group view's manual group ordering
// ───────────────────────────────────────────────────────────────────
//
// Reorders via full `render()` re-draws rather than in-place DOM moves,
// so drag state, up/down button disabled-state, and the option list
// never drift out of sync with `this.order`. Mobile gets up/down
// buttons alongside drag handles since touch drag-and-drop is unreliable.
