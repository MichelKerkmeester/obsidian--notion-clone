// ───────────────────────────────────────────────────────────────────
// MODULE:    add-database-flow
// COMPONENT: shared "new database" pipeline — frontmatter scan, column inference, confirm modal
// ───────────────────────────────────────────────────────────────────
//
// Exists so the dashboard/toolbar and settings-panel entry points build
// databases identically; the settings path previously duplicated a
// bare file.name-only config and silently skipped column inference.
...
import {
  ...
  getVaultTags,
  inferColumnType,
} from "../../data/frontmatter-scanner";
import { AddDatabaseModalResult, applyAddDatabaseResult } from "../../data/add-database-result";
import { BaseImportColumn, BaseImportConfirmModal } from "./base-import-confirm-modal";
import { t } from "../../i18n";
