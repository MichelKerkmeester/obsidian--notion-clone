// ───────────────────────────────────────────────────────────────────
// MODULE:    invalid-time-events-modal
// COMPONENT: bulk repair grid for timeline events whose start is on/after their end
// ───────────────────────────────────────────────────────────────────
//
// Pure `date` columns render a `date` input rather than `datetime-local`
// so a user can't type a time value that gets silently truncated on
// write-back — that truncation was previously producing a "fixed" event
// that goes invalid again on the very next reload.
