// ───────────────────────────────────────────────────────────────────
// MODULE:    status-options-modal
// COMPONENT: per-column status/select option editor, with preset switching and drag reorder
// ───────────────────────────────────────────────────────────────────
//
// Editing any option value/color/order calls `markCustomOptions()` first,
// which detaches the column from its active preset — otherwise a hand
// edit would look like it belongs to the preset and get silently
// overwritten the next time that preset is selected elsewhere.
