// ───────────────────────────────────────────────────────────────────
// MODULE:    base-import-confirm-modal
// COMPONENT: scanned-frontmatter review table shared by database-import and new-database flows
// ───────────────────────────────────────────────────────────────────
//
// Per-row and header checkboxes share `applyRangeSelection`/`selectAll`
// so shift-click range-select behaves identically to the header
// select-all, and `defaultUnchecked` lets a fresh-database import start
// opt-in instead of opt-out without a second code path.
