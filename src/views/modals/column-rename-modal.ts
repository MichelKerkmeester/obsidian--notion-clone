// ───────────────────────────────────────────────────────────────────
// MODULE:    column-rename-modal
// COMPONENT: rename/retype prompt for an existing column, with a value-migration option
// ───────────────────────────────────────────────────────────────────
//
// File-derived fields (e.g. file.name) lock the key input, and computed
// or rollup columns disable the migrate-values checkbox — both are
// derived values a rename can't safely carry forward.
