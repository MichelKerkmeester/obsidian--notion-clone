// ───────────────────────────────────────────────────────────────────
// MODULE:    computed-frontmatter-cleanup-modal
// COMPONENT: checklist prompt for stripping stale computed-field frontmatter keys
// ───────────────────────────────────────────────────────────────────
//
// Selection supports shift-click range toggling via `applyRangeSelection`
// so a user cleaning up dozens of stale keys after a schema change isn't
// forced to click every checkbox individually.
