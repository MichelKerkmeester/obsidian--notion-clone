// ───────────────────────────────────────────────────────────────────
// MODULE:    inline-markdown-renderer
// COMPONENT: DOM renderer for inline-markdown tokens, plus hidden-cell
//            width measurement for column auto-fit
// ───────────────────────────────────────────────────────────────────

/**
 * DOM renderer for the inline-markdown token tree (src/data/inline-markdown.ts).
 *
...
import { parseInlineMarkdown, type InlineMarkdownNode } from "../data/inline-markdown";
