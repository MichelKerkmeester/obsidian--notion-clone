// ───────────────────────────────────────────────────────────────────
// MODULE:    group-expand-controls
// COMPONENT: "show more / show all / collapse" controls for a row-limited group
// ───────────────────────────────────────────────────────────────────
//
// Rendered identically from table, board, gallery, and list so all four
// grouped renderers share one expand affordance and the same count semantics.
...
import { t } from "../i18n";
import { getGroupRowLimit, getGroupVisibleCount } from "../data/group-visibility";
