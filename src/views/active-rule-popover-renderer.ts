// ───────────────────────────────────────────────────────────────────
// MODULE:    active-rule-popover-renderer
// COMPONENT: single shared edit popover for the active filter/sort chip row
// ───────────────────────────────────────────────────────────────────
//
// Filter and sort chips share one popover instance keyed by `kind:index`,
// so opening a second chip closes the first instead of stacking panels.
// Toggling the same key again closes rather than reopening it, matching
// the click-to-dismiss expectation on the chip that is already active.

// ───────────────────────────────────────────────────────────────────
// 1. IMPORTS
// ───────────────────────────────────────────────────────────────────

import { FilterPanelActions, FilterPanelRenderer } from "./filter-panel-renderer";
import { installPopoverAutoClose } from "./popover-auto-close";
import { positionToolbarPopover } from "./popover-position";
import { SortPanelActions, SortPanelRenderer } from "./sort-panel-renderer";
