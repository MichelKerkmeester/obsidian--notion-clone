// ───────────────────────────────────────────────────────────────────
// MODULE:    drag-drop-feedback.test
// COMPONENT: unit tests for drag-drop placement state, phases, and a11y status
// ───────────────────────────────────────────────────────────────────
//
// Stubs a minimal HTMLElement (classList, dataset, getBoundingClientRect)
// instead of pulling in a real DOM, since these tests only need to observe
// class-list mutations and the resolved placement, not real layout.
