// ───────────────────────────────────────────────────────────────────
// MODULE:    calendar-timeline-toolbar-renderer
// COMPONENT: settings popover for the timeline view (data/layout/style fields)
// ───────────────────────────────────────────────────────────────────
//
// Rebuilding the whole popover on every field change would flash the
// async "calculating..." invalid-events notice back to its loading state,
// so a scale or column-width toggle rebuilds only its own section
// (renderLayoutContent) rather than the full renderTimelineOptions tree.
...
import { getTimelineColumnWidthSpec, normalizeTimelineDayScale } from "../data/calendar-timeline-model";
