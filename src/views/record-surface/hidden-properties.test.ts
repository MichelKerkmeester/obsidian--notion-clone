...
function makeGroup() {
  return createHiddenPropertiesGroup({
    ...
    sectionClass: "db-hidden-section",
    sectionHeaderClass: "db-hidden-section-header",
    sectionTitleClass: "db-hidden-section-title",
    bulkLinkClass: "db-hidden-bulk-link",
    rowClass: "db-hidden-row",
    dragHandleClass: "db-hidden-drag",
    dragHandleTitle: "Drag to reorder",
    typeClass: "db-hidden-type",
    nameWrapClass: "db-hidden-name-wrap",
    nameClass: "db-hidden-name",
    eyeClass: "db-hidden-eye",
    chevronClass: "db-hidden-chevron",
