// ───────────────────────────────────────────────────────────────────
// MODULE:    database-file-view
// COMPONENT: Obsidian view that scopes a database dashboard to one note file
// ───────────────────────────────────────────────────────────────────
//
// Narrows the generic multi-database DatabaseView to exactly one backing
// TFile, and keeps that file reference in sync across Obsidian's
// open/rename/state-restore lifecycle so the tab title and leaf ephemeral
// state never drift from the file the dashboard was opened for.
