// ───────────────────────────────────────────────────────────────────
// MODULE:    calendar-toolbar-renderer
// COMPONENT: settings popover for the calendar view (data/layout/time/appearance)
// ───────────────────────────────────────────────────────────────────
//
// Mirrors calendar-timeline-toolbar-renderer's popover shell and section
// pattern deliberately rather than sharing a base class: the two views'
// field sets diverge enough (month/week/day scale controls vs. timeline
// scale controls) that a shared abstraction would need as many branches
// as just keeping the two renderers side by side.
...
import { t } from "../i18n";
import { HOUR_HEIGHT_MIN } from "../data/calendar-layout-model";
