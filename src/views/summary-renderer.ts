...
// COMPONENT: Group/database summary bar — aggregation values, drag reorder, edit menus
// ───────────────────────────────────────────────────────────────────
//
// calculateSupportedCustomSummary hand-matches a fixed set of legacy
// summaryFormulas expression shapes (e.g. "values.filter(...).sum()") with
// regexes instead of evaluating them, since those strings come from
// persisted config and must never reach eval/Function.
