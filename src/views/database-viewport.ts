// ───────────────────────────────────────────────────────────────────
// MODULE:    database-viewport
// COMPONENT: capture/restore scroll position across database rerenders
// ───────────────────────────────────────────────────────────────────
//
// A full rerender (column/row reflow, view switch) would otherwise reset
// scroll to the top. This module anchors the scroll position to a specific
// visible row/column so a rerender can put the user back where they were,
// including when the database is embedded in a note — where the real
// scroll container lives on the host document, not the database's own.
