// ───────────────────────────────────────────────────────────────────
// MODULE:    edge-auto-scroller
// COMPONENT: pointer-proximity autoscroll for drag-and-drop interactions
// ───────────────────────────────────────────────────────────────────
//
// Shared by table row and board card drag handlers: velocity ramps with
// `acceleration` instead of jumping to max speed, and the animation frame
// is only (re)scheduled while velocity is non-zero, so a drag that pauses
// away from an edge does not leave a dangling rAF loop running.
