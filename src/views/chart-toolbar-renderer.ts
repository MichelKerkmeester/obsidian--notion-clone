// ───────────────────────────────────────────────────────────────────
// MODULE:    chart-toolbar-renderer
// COMPONENT: Chart options toolbar — renders the two-level popover (main panel + child popovers) that edits chart ViewConfig fields
// ───────────────────────────────────────────────────────────────────
//
// Every control mutates the ViewConfig object in place and calls
// actions.onChange() to trigger a re-render — the popover holds no field
// state of its own. Child popovers (value/aggregation, visible-groups,
// reference-line color) stack on top of the main panel, so outside-click
// and Escape close the child popover first, then the parent.
...
import { getColumnOptionValues } from "../data/column-types";
import {
...
} from "../data/chart-aggregation";
import { getChartPalettePreviewColors } from "../data/chart-palettes";
import { getChartAutoTitle, getDefaultChartAggregationForValueField, isChartAggregationAllowedForValueField, isChartCumulativeSupported, normalizeChartAggregationForValueField, normalizeChartConfigForType, normalizeChartSecondaryAggregationForValueField } from "../data/chart-view-model";
