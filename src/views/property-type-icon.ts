// ───────────────────────────────────────────────────────────────────
// MODULE:    property-type-icon
// COMPONENT: per-column-type SVG icon defs and the dropdown-icon
//            encoding used to show them inside menu/dropdown options
// ───────────────────────────────────────────────────────────────────
//
// Icon paths are hand-copied Tabler outline glyphs (kept inline rather
// than imported from a package) so the plugin ships without a runtime
// icon-font dependency. Dropdown menus can only reference icons by name
// string, not arbitrary markup, so a property-type icon is encoded as
// `property:<type>` and decoded back into real SVG paths at render time
// by `renderDropdownPropertyTypeIcon`.
