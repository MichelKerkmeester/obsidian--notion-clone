...
- **Images**: Mobbin serves thumbnails through short links; iOS captures are 299×678 webp, web captures are 768×521 webp (a few differ). No image failed to download; every id returned by the tools has a file on disk.
