...
| `specs/001-note-db-notion-parity-build/006-link-scheme-fields/spec.md` | Add | This specification |
| `specs/001-note-db-notion-parity-build/006-link-scheme-fields/plan.md` + `tasks.md` + `checklist.md` + `implementation-summary.md` | Add | Phase plan, task breakdown, verification checklist, and summary |
