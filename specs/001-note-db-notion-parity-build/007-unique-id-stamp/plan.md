...
|-----------|-------|-------|
| Strict validation | This phase folder | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/001-note-db-notion-parity-build/007-unique-id-stamp --strict` |
