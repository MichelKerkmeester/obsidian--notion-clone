...
- [x] T020 Run packet strict validation (`bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/001-note-db-notion-parity-build/007-unique-id-stamp --strict`) [10m] -- strict validator exit 0
...
- [ ] Strict validation passed. Pending — command is `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/001-note-db-notion-parity-build/007-unique-id-stamp --strict`.
