...
- [x] All tasks marked `[x]` — T013 landed this session (see its own row for the sheet-grammar residual it left, tracked against AC-005 rather than against this task)
