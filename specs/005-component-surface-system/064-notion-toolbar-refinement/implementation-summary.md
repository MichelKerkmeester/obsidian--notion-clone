...
acceptance rows and nine decisions; it carries no code.
...
seven criteria), `spec.md` (REQ-001 through REQ-008), `plan.md`, `tasks.md` (T001-T013),
`acceptance-criteria.md` (AC-001 through AC-011), `decision-record.md` (ADR-001 through ADR-009, plus
the four corrections), and the loop that produced them at
...
make the reds visible, six code legs of which three wait on the operator's ADR answers, and three
