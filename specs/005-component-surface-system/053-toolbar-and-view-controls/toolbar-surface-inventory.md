...
| T11 | 120 catalogue captures scanned, `set-viewlist-dark-full`, `view-settings-panel-dark` | Funnel `ink=52, sat=0` on filtered **and** unfiltered — C1 re-derived on light theme. Expanded state is a **28×28px `#232323` fill at 1.14:1** (corrected 2026-09-05 from 1.20:1), refused |
