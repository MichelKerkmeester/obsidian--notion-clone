...
| `048` T025 absorbed here as T020 rather than left open there | It is a capture gap for the depth-3 chains, and this packet is the one adding the depth-3 behaviour the capture would photograph |
<!-- /ANCHOR:decisions -->
