...
**`045-board-card-properties` carries two operator questions that are not part of the numbered
report list above and remain unanswered:** does gallery share the visible-properties mechanism, and
should hiding a card field also hide it in the table. See the `045` row in §5.A.
