...
`972c2cd`/`a00ad31`. Both are installed to the iCloud vault. The cadence continues at **0.0.18**
...
`972c2cd`/`a00ad31`, cut in `839712b`; the `0.0.16` and `0.0.17` tags are both present on `origin`,
verified with `git ls-remote --tags`. None of 0.0.7 through 0.0.17 is operator-confirmed yet.
