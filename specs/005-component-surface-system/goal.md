...
|---|---|---|---|
| `059-notion-board-refinement` | the board — owner `056-board-anytype-parity` | **Opened 2026-09-06**, 0/10, from `worktrees/174`. The first of the eight to land | the Notion research synthesis |
...
| `061-notion-sheet-refinement` | the sheet family — owners `051`, `044`, `048` | **OPENED 2026-09-06**, Level 3, standard child, 0/7 | its own Opus synthesis, from the five-iteration Notion loop plus the operator's 17:07 cell-menu report |
| `062-notion-table-refinement` | the table view — `053` and `052` own its files; the packet now exists | **Opened 2026-09-06 ~16:17**, 0/9, Level 3 — wave 1's first landing | the Notion research synthesis, 5/5 iterations in `worktrees/177` |
| `063-notion-dropdown-refinement` | dropdowns, menus and pickers — owner `052-dropdown-menu-and-picker-componentization` | **Opened 2026-09-06 in `worktrees/179`** — the first wave-2 child to land. Research 5/5, synthesis landed, Level 2, 0/7 | the Notion research synthesis |
...
| `065-notion-record-refinement` | the record and relation surfaces — owners `054`, `058` | **OPENED 2026-09-06**, Level 2, standard child, **0/7** | the Notion research synthesis, `054/research/research.md` |
| `066-notion-states-refinement` | states, feedback and motion — owner `055-states-feedback-and-motion` | **OPENED 2026-09-06**, not started — the loop ran and the synthesis landed the packet | the Notion research synthesis |
