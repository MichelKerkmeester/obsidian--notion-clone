...
| `064-notion-toolbar-refinement` | the toolbar and view controls — owner `053-toolbar-and-view-controls` | **Still planned. Research and synthesis in flight at 2026-09-06 20:10** on GLM DevPass, Opus lander waiting; it carries the conditional-colour view-settings row | the Notion research synthesis |
