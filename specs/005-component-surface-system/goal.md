...
|---|---|---|---|
| `059-notion-board-refinement` | the board — owner `056-board-anytype-parity` | **Opened 2026-09-06** at `9d9515ae`, 0/10, from `worktrees/174`. The first of the eight to land; ADR-004/010/011 ruled the same evening | the Notion research synthesis |
