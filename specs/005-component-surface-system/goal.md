...
| `060-notion-calendar-refinement` | the calendar — owner `057-calendar-anytype-parity` | **OPENED 2026-09-06**, Level 2, standard child, 0/5. The loop ran 5/5 in `worktrees/175` and its synthesis opened the packet | the Notion research synthesis |
