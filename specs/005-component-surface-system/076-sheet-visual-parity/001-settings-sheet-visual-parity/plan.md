...
description: "The six-step loop for the Settings Sheet: define, plan, create, screenshot, verify, remediate — with the mount path, the lane clauses and the judge named."
trigger_phrases:
  - "implementation plan"
  - "076 phase 1 plan"
  - "001 six step loop"
