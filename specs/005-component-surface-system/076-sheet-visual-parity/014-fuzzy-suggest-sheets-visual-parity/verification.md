---
title: "Verification: Phase 14: Fuzzy File-Suggest Sheets Visual Parity"
...
trigger_phrases:
  - "014-fuzzy-suggest-sheets-visual-parity verification"
  - "014-fuzzy-suggest-sheets-visual-parity judge score"
  - "014-fuzzy-suggest-sheets-visual-parity verification.md"
importance_tier: "important"
contextType: "implementation"
---
<!-- SPECKIT_TEMPLATE_SOURCE: acceptance-criteria | v2.2 -->
# Verification: Phase 14: Fuzzy File-Suggest Sheets Visual Parity
...
- [ ] The operator has read a file/image/markdown picker on their own iPhone and reports it aligned with the reference — never ticked by an agent
<!-- /ANCHOR:operator -->
