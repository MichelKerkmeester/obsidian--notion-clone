...
![Anytype desktop search palette, query state — form-factor mismatch (desktop vs our sheet), recorded in spec.md §13](../../../../screenshots/anytype/desktop/app/anytype-search-palette-query-dark.png)
![Anytype desktop search palette, recent state — same form-factor caveat](../../../../screenshots/anytype/desktop/app/anytype-search-palette-recent-dark.png)
