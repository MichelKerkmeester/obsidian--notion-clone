---
title: "Goal: Record Menu, Cell Menu and Destructive Confirm Visual Parity"
description: "The durable directive this phase executes against and the criteria that decide when it is done."
trigger_phrases:
  - "packet goal"
  - "009-menu-and-confirm-visual-parity goal"
  - "009 completion criteria"
...
_memory:
  continuity:
    ...
    recent_action: "Opened 009's goal with the rubric thresholds and the operator row"
...
# Goal: Record Menu, Cell Menu and Destructive Confirm Visual Parity
...
**Objective:** The row menu, the column/cell menu and the destructive confirm card against Notion's menus and delete confirms, including the action order 071/013 already ruled on. This phase takes it through the programme's six-step loop until a reviewer, opening our capture beside the reference, scores it **≥ 14/16 with no row at 0, twice consecutively on an unchanged tree**.
...
Opened as phase 9 of `076-sheet-visual-parity`. The references in `spec.md` §13 were selected this session and the gaps they cannot answer are recorded there rather than filled by inference.
