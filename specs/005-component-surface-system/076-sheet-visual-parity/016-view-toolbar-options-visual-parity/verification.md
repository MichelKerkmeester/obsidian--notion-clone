---
title: "Verification: Phase 16: View-Specific Toolbar Option Popovers Visual Parity"
...
trigger_phrases:
  - "016-view-toolbar-options-visual-parity verification"
  - "016-view-toolbar-options-visual-parity judge score"
  - "016-view-toolbar-options-visual-parity verification.md"
importance_tier: "important"
contextType: "implementation"
---
<!-- SPECKIT_TEMPLATE_SOURCE: acceptance-criteria | v2.2 -->
# Verification: Phase 16: View-Specific Toolbar Option Popovers Visual Parity
...
- **(b) Image judge.** The eight-row rubric below, scored 0-2 each, maximum 16, on the anchor surface. Pass is **>= 14/16 with no row at 0**, twice consecutively on an unchanged tree. The other three surfaces are checked for internal consistency, noted per iteration.
...
tree, with the three no-reference surfaces noted consistent in the same iteration.
<!-- /ANCHOR:iterations -->
...
- [ ] The operator has read a view-toolbar popover on their own iPhone and reports it aligned with the reference — never ticked by an agent
<!-- /ANCHOR:operator -->
