---
title: "Verification: Phase 17: Utility DbModal Sheets Visual Parity"
...
trigger_phrases:
  - "017-utility-modal-sheets-visual-parity verification"
  - "017-utility-modal-sheets-visual-parity judge score"
  - "017-utility-modal-sheets-visual-parity verification.md"
importance_tier: "important"
contextType: "implementation"
---
<!-- SPECKIT_TEMPLATE_SOURCE: acceptance-criteria | v2.2 -->
# Verification: Phase 17: Utility DbModal Sheets Visual Parity
...
- **(b) Image judge.** The eight-row rubric below, scored 0-2 each, maximum 16, on the representative sample, for internal consistency (no external reference exists). Pass is **>= 14/16 with no row at 0**, twice consecutively on an unchanged tree.
...
- [ ] The operator has read a utility modal on their own iPhone and reports it aligned with the rest of the sheet family — never ticked by an agent
<!-- /ANCHOR:operator -->
