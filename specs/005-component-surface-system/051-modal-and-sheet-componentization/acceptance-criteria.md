...
_memory:
  continuity:
    ...
    recent_action: "Wrote t002's confirmed red baselines into every unmet row"
    next_safe_action: "Operator review of ADR-006, then begin Phase 2 legs (T004+)"
    blockers:
      - "AC-006's Verification wording needs ADR-006 (Proposed) resolved before it reads as observable red"
...
`decision-record.md` ADR-006 (Proposed) restates it against today's scattered-literal count instead.
