...
- **Decisions**: See `decision-record.md` ADR-001 (Anytype research-cap override) and ADR-002 (AppFlowy installed captures skipped; Anytype demo space persistent)
<!-- /ANCHOR:cross-refs -->
