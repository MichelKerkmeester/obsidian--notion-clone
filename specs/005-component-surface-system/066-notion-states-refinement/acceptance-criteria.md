...
`tasks.md` T017 exactly as scoped. What was consciously left out: the permanent browser-measured lane
row (`tasks.md` T012, which would have caught the `box-sizing` defect without a person going looking),
and the five refused Notion patterns in `goal.md` §4.
<!-- /ANCHOR:closure -->
