...
| C7 | Bespoke `preferredWidth` literals in the family | **9 distinct values** across 9+ sites: 420, 360, 318, 292, 280, 252, 240, 124, 520 (`grep -rn "preferredWidth: [0-9]"`, counted 2026-09-05) | every value mapped to a named role or written reason in `componentization-plan.md` §3 | [ ] |
