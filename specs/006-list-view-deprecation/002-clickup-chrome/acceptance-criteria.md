...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Measurement plans for the chrome criteria, the per-criterion negative controls, and the three checks every row here had to pass before it was accepted."
trigger_phrases:
