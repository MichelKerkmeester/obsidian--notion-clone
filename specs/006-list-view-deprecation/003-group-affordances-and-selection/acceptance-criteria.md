...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Measurement plans for AC-22 and AC-23, both phrased across a boundary so neither passes on the surface it changed."
trigger_phrases:
