...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Wire and reach the per-group create row, the group count, and the selection-sync defect that leaves the list group checkbox stale after any change from another surface."
trigger_phrases:
  - "006 phase 003"
  - "group create row"
...
| Field | Value |
|---|---|
| **Spec Folder** | `specs/006-list-view-deprecation/003-group-affordances-and-selection/` |
