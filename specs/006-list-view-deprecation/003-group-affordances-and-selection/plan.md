...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Fix the sync at its source rather than at the surface that noticed, wire the create row to its own group, and stay off the released stylesheet lane."
trigger_phrases:
  - "006 phase 003 plan"
