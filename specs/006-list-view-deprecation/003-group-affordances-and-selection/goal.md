---
title: "Goal: Group Affordances and Selection (Superseded)"
description: "The durable directive this packet executes against, and the criteria that decide when it is done."
trigger_phrases:
  - "006 003 goal"
  - "group affordances superseded"
  - "list selection semantics history"
importance_tier: "informational"
contextType: "planning"
_memory:
  continuity:
    packet_pointer: "006-list-view-deprecation/003-group-affordances-and-selection"
    ...
    session_dedup:
      ...
      session_id: "list-deprecation-003-goal"
      parent_session_id: null
    completion_pct: 100
    open_questions: []
    answered_questions: []
---
# Goal: Group Affordances and Selection (Superseded)
...
**Objective:** Superseded. This phase was opened to: Give each group its own create affordance and settle selection semantics across groups. The operator retired the list view on 2026-09-04, so it is kept as history and executes nothing.
