...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Criteria with the failing number recorded first, so a pass means something actually changed."
trigger_phrases:
...
- [ ] `validate.sh specs/006-list-view-deprecation --strict` reports `RESULT: PASSED`
