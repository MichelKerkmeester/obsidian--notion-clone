...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Measurement plans for the phone criteria, which cite no capture, and AC-26, which has no automated substitute."
trigger_phrases:
