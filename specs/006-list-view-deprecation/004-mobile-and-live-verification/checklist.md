...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Phone targets, focus rings, the two deferred guards, the tripwire re-run, and the operator's device confirmation."
trigger_phrases:
