...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). The two guard tripwires with their fixtures and arming procedure, and the census obligations this phase owns. Definitions live in the parent register; this file is the measurement plan."
trigger_phrases:
