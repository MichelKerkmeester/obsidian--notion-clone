...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). The structural swap. The list renders through the grid renderer behind data-db-row-style: header row repeated per group, sort, resize, reorder, add-column, the shared cell pipeline, cell selection, footer and multi-group. Seven guards convert here, two more in 004, and two never do."
trigger_phrases:
  - "006 phase 001"
  - "list grid structure"
  - "data-db-row-style"
...
_memory:
  continuity:
    packet_pointer: "006-list-view-deprecation/001-list-grid-structure"
...
| Field | Value |
|---|---|
| **Spec Folder** | `specs/006-list-view-deprecation/001-list-grid-structure/` |
...
| **Status** | **Superseded 2026-09-04** — was: Planned — blocked on phase 000 |
