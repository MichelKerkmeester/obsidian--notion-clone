...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). ADR-P1-01 — whether the row's leading gutter is emitted as its own header cell or as padding on the first cell, and why AC-01 cannot be measured until it is decided."
trigger_phrases:
  - "006 phase 001 adr"
