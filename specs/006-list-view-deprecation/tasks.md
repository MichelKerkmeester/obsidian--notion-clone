...
description: "SUPERSEDED 2026-09-04 (ClickUp direction, replaced by the list-view deprecation). Tasks grouped by the five planned phases, each naming the file it touches and the evidence that closes it."
trigger_phrases:
  - "006 list view tasks"
...
6. `validate.sh specs/006-list-view-deprecation --strict` reports `RESULT: PASSED`.
