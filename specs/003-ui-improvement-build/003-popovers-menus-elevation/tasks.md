...
- [x] T011 **(rank 2) Mobile bottom sheets & safe-area overlays**: implement `.db-mobile-bottom-sheet` on `.is-phone` viewports with top drag handle, dimmed backdrop scrim, and `env(safe-area-inset-bottom)` safe-area insets in `PopoverPosition.ts:24-90, 124-148` and `styles.css:14260` [M]
...
- [x] T014 **(rank 2 / iter 03) Apply Phase 005's 3-tier elevation & glassmorphism tokens**: consume `--db-elevation-1`, `--db-elevation-2`, `--db-elevation-3`, and the z-index layer scale defined by Phase 005; apply the shared `backdrop-filter: blur(12px)` contract without declaring competing tokens (`styles.css:114, 2364-2368, 2758-2765, 4590-4594, 5334-5345, 5583-5592, 15941-15951, 16429-16460`) [S]
...
- [x] T054 Mobile bottom sheet check: verify `.db-mobile-bottom-sheet` on `.is-phone` viewports with safe-area insets and backdrop tap dismissal (`src/views/PopoverPosition.ts:24-90, 124-147`, `styles.css:14260`) [15m]
