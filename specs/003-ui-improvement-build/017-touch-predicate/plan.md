---
title: "Implementation Plan: One Canonical Touch Predicate"
description: "Approach, gates and rollback for 017-touch-predicate, covering inventory items #2, #3, #9, #10."
trigger_phrases:
  - "017 touch predicate plan"
importance_tier: "high"
contextType: "planning"
---
# Implementation Plan: One Canonical Touch Predicate
...
Make one predicate canonical and retire the threshold mismatch, so the FAB and the sheets agree about what a phone is. Covers inventory items #2, #3, #9, #10. The governing analysis is
...
Predecessor `016-overlay-contracts`. The decision matrix's dependency order governs; a phase that depends on an
