---
title: "Implementation Plan: Modal Surface Taxonomy and Plugin-Owned Menus"
description: "Approach, gates and rollback for 018-surface-taxonomy-and-menus, covering inventory items #3, #8."
trigger_phrases:
  - "018 surface taxonomy and menus plan"
importance_tier: "high"
contextType: "planning"
---
# Implementation Plan: Modal Surface Taxonomy and Plugin-Owned Menus
...
Give each modal the presentation its content deserves, and retire the private-field liability. Covers inventory items #3, #8. The governing analysis is
...
Predecessor `017-touch-predicate`. The decision matrix's dependency order governs; a phase that depends on an
