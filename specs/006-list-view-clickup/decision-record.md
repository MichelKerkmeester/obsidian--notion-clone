...
description: "ADR-001 port versus presentation mode, ADR-002 the sort indicator re-decided on the operator screenshot, ADR-003 how a select cell advertises that it is editable, ADR-004 the reserved leading gutter that replaces the checkbox-swap reading."
trigger_phrases:
  - "006 list view adr"
