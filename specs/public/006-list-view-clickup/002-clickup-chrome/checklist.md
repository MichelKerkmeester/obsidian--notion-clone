...
description: "Chrome criteria against the numbers phase 000 recorded, the negative-control register, and the four lane-release conditions with a named signature."
trigger_phrases:
