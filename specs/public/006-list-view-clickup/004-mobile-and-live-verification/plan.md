...
description: "Phone targets justified without the reference, the two deferred guards taken one at a time, and a device check that names the two affordances that had zero rules."
trigger_phrases:
  - "006 phase 004 plan"
