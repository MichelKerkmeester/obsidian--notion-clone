...
description: "Phone layout and touch targets, the two deferred guards, and the only evidence that closes the packet: the operator opens the plugin and confirms the screen changed."
trigger_phrases:
  - "006 phase 004"
