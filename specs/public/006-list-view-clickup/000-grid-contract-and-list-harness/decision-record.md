...
description: "ADR-P0-01 — a guard tripwire's failing-first demonstration is against a deliberately mutated tree, not against HEAD, and why that is not a loophole in the packet's criteria doctrine."
trigger_phrases:
  - "006 phase 000 adr"
