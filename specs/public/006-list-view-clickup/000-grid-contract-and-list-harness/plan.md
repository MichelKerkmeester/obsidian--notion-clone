...
description: "Build the predicate, re-derive the guard table off a stable anchor, arm the two guard tripwires against a deliberately converted guard, make the harness mount a real list, and take the census read-only."
trigger_phrases:
  - "006 phase 000 plan"
