...
description: "Take the lane, route the list through the grid behind data-db-row-style, convert seven guards in one revertible commit, remove the four reading behaviours FR-17 used to protect, and gate on the two tripwires from 000."
trigger_phrases:
  - "006 phase 001 plan"
