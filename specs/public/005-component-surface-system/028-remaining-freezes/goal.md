...
- [ ] The scaling verdict is not SUPERLINEAR at any measured shape up to 12,800 rows. **Confirmed
      ...
      per-row cost flat at 0.057–0.063ms and the prior state restoring ×1.92 as control. **The table
      sweep has not been re-run** and still reads ×4.5, so this row stays open.
