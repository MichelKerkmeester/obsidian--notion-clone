...
### Documentation
- [ ] T018 Record observed evidence in `checklist.md` and `implementation-summary.md` after commands pass (`specs/public/001-note-db-notion-parity-build/008-derived-inverse-relations/checklist.md`) [S]
...
- [ ] Strict validation passed: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/public/001-note-db-notion-parity-build/008-derived-inverse-relations --strict` → `Summary: Errors: 0  Warnings: 0`.
