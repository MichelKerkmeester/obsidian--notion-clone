---
title: "Task Breakdown: Bounded Wrapping and a Shared Density Contract"
description: "Tasks for 019-row-geometry, one per requirement, each closed only with read evidence."
trigger_phrases:
  - "019 row geometry tasks"
importance_tier: "high"
contextType: "planning"
---
# Task Breakdown: Bounded Wrapping and a Shared Density Contract
...
- [ ] **T-001** With wrap off, every row in a view shares one height
- [ ] **T-002** List items obey the same density contract as table rows
- [ ] **T-003** The clip is achieved with CSS on the existing cell. Introducing a new inner wrapper node would force every table fixture to gain that node
- [ ] **T-004** Item 13 lands before item 14, so list consumes the table's policy rather than inventing another
