...
- [x] T007 [M] Pin single authoritative fill handle `.db-cell-fill-handle` strictly to the bottom-right corner cell of the active selection in `src/views/DatabaseView.ts:7971-7984` and `styles.css:4977-4993` (`src/views/DatabaseView.ts:8390-8416`, `styles.css:5542-5561`) (REQ-001)
- [x] T008 [M] Redesign `.db-selection-status-bar` in `src/views/DatabaseView.ts:7010-7125` and `styles.css:1697-1718` as a fixed bottom floating glassmorphic dock with backdrop blur, count badge, semantic actions, and `[✕ Esc]` clear pill (`src/views/DatabaseView.ts:7330-7450`, `styles.css:1995-2045`) (REQ-002)
...
- [x] T014 [S] Replace card drop box-shadows in `src/views/BoardRenderer.ts:531-541` and `styles.css:7307-7317` with dedicated 2px accent drop indicator line `.db-board-drop-indicator` (`src/views/BoardRenderer.ts:1155-1163`, `styles.css:5790-5809`) (REQ-011)
...
- [x] T019 [S] Detect broken wikilinks in `src/views/RelationValueRenderer.ts:18-35` via `app.metadataCache.getFirstLinkpathDest()` and render dashed warning pill `.is-unresolved` with tooltip in `styles.css:4870-4910` (`src/views/RelationValueRenderer.ts:20-29`, `styles.css:5613-5628`) (REQ-007)
...
- [x] T024 [M] Render shimmering skeleton loader `.db-skeleton-loader` during view switches > 60ms around the refresh teardown in `src/views/DatabaseView.ts:10631-10646` and `styles.css:6130-6160` (`src/views/DatabaseView.ts:11425-11446`, `styles.css:2107-2135`) (REQ-009)
...
- [x] T026 [S] Render debounced search activity pulse indicator inside `.db-search-input-wrap` in `src/views/ToolbarRenderer.ts:1087-1123` and `styles.css:2687-2750` (`src/views/ToolbarRenderer.ts:1435`, `styles.css:3200-3215`) (REQ-015)
...
- [x] T029 [S] Run Vitest unit test suite `npx vitest run` (`src/views/DragDropFeedback.ts:1-47`, 315 tests across 41 files)
