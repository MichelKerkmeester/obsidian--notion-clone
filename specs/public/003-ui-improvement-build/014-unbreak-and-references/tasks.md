---
title: "Task Breakdown: Unbreak the Tree and Acquire References"
description: "Tasks for 014-unbreak-and-references, one per requirement, each closed only with read evidence."
trigger_phrases:
  - "014 unbreak and references tasks"
importance_tier: "high"
contextType: "planning"
---
# Task Breakdown: Unbreak the Tree and Acquire References
...
- [ ] **T-001** `tsc --noEmit` exits 0 with no output
- [ ] **T-002** `screenshots:verify` exits 0 with all 196 entries matching
- [ ] **T-003** `external/` is gitignored before either clone lands, and never appears in `git status`
- [ ] **T-004** Reference reading is behaviour-only. Both repos are AGPL or source-available; this plugin is MIT (`LICENSE:1-3`). No code, CSS values, token scales or asset geometry may be copied.
