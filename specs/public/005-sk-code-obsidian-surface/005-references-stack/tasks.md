...
_memory:
  continuity:
    packet_pointer: "public/005-sk-code-obsidian-surface/005-references-stack"
...
- [x] T010 [P] Read the release and repo-convention sources (`.github/workflows/release.yml`, `versions.json`, `AGENTS.md`, `REPO RULES.md`, `specs/public/HANDOVER.md`, `README.md`)
