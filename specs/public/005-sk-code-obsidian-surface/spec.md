...
_memory:
  continuity:
    packet_pointer: "public/005-sk-code-obsidian-surface"
...
- The six open P0/P1 items and the roughly 145 unphotographed surfaces recorded in
  `specs/public/HANDOVER.md`. They are encoded as evidence in this packet's references and
...
- `specs/public/HANDOVER.md` — the traps and the open debt this packet encodes as evidence.
