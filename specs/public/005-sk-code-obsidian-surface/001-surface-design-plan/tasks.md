...
_memory:
  continuity:
    packet_pointer: "public/005-sk-code-obsidian-surface/001-surface-design-plan"
...
- [x] T006 [P] Read the plugin repo's own `AGENTS.md`, `package.json`, and one sibling leaf `spec.md` for the spec-kit shape (`specs/public/003-ui-improvement-build/001-empty-and-first-run-states/spec.md`)
...
- [x] CHK-050 [P1] No file created outside `specs/public/005-sk-code-obsidian-surface/001-surface-design-plan/`
