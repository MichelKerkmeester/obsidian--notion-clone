...
_memory:
  continuity:
    packet_pointer: "public/005-sk-code-obsidian-surface/008-scanners-and-gates"
...
- [x] CHK-050 [P1] No file created outside `tools/naming/` and `specs/public/005-sk-code-obsidian-surface/008-scanners-and-gates/`
