...
_memory:
  continuity:
    packet_pointer: "public/005-sk-code-obsidian-surface/006-assets-checklists"
...
`specs/public/HANDOVER.md`), plus the packet's own `mode-design-plan.md` and
...
- [x] `002-repo-convention-audit/audit.json` and `specs/public/HANDOVER.md` read for measured
